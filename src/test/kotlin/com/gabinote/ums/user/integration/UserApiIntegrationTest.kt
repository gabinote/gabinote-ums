        ...
        feature("[User] User API Integration Test") {
            ...
            feature("[GET] /api/v1/user/me") {
                scenario("인증된 사용자가 자신의 정보를 요청하면, 전체 사용자 정보를 반환해야 한다.") {
                    Given {
                        testDataHelper.setData("/testsets/user/integration/get-api-v1-user-me.json")
                        basePath(apiPrefix)
            ...
            feature("[GET] /api/v1/user/{uid}") {
                scenario("공개 프로필 사용자의 정보를 조회하면, 최소 정보를 반환해야 한다.") {
                    Given {
                        testDataHelper.setData("/testsets/user/integration/get-api-v1-user-uid-open.json")
                        basePath(apiPrefix)
                        accept("application/json")
                ...
                scenario("비공개 프로필 사용자의 정보를 조회하면, 403 에러를 반환해야 한다.") {
                    Given {
                        testDataHelper.setData("/testsets/user/integration/get-api-v1-user-uid-closed.json")
                        basePath(apiPrefix)
                        accept("application/json")
                        header("X-Token-Sub", "a15cdbf8-22bc-47e2-9e9a-4d171cb6522f")
                        header("X-Token-Roles", "user")
            ...
            feature("[POST] /api/v1/user/me/register") {
                scenario("올바른 회원가입 요청이 주어지면, 새로운 사용자를 생성하여 반환해야 한다.") {
                    Given {
                        testDataHelper.setData("/testsets/user/integration/post-api-v1-user-me-register-before.json")
                        basePath(apiPrefix)
                        accept("application/json")
                        ...
                        statusCode(201)
                        testDataHelper.assertData("/testsets/user/integration/post-api-v1-user-me-register-after.json")
            ...
            feature("[PUT] /api/v1/user/me") {
                scenario("올바른 정보 수정 요청이 주어지면, 사용자 정보를 수정하여 반환해야 한다.") {
                    Given {
                        testDataHelper.setData("/testsets/user/integration/put-api-v1-user-me-before.json")
                        basePath(apiPrefix)
                        accept("application/json")
                        header("X-Token-Sub", "d15cdbf8-22bc-47e2-9e9a-4d171cb6522e")
                        header("X-Token-Roles", "user")
                        ...
                        statusCode(200)
                        testDataHelper.assertData("/testsets/user/integration/put-api-v1-user-me-after.json")
                        body("uid", equalTo("d15cdbf8-22bc-47e2-9e9a-4d171cb6522e"))
            ...
            feature("[POST] /api/v1/user/me/withdraw") {
                scenario("인증된 사용자가 회원 탈퇴를 요청하면, 탈퇴 처리되고 204를 반환해야 한다.") {
                    Given {
                        testDataHelper.setData("/testsets/user/integration/post-api-v1-user-me-withdraw.json")
                        basePath(apiPrefix)
                        accept("application/json")
                        ...
                        statusCode(204)
                        testDataHelper.assertData("/testsets/user/integration/post-api-v1-user-me-withdraw-after.json")
